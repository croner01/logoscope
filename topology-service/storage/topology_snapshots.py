...
_snapshot_manager_storage = None
...
def get_topology_snapshot_manager(storage_adapter) -> TopologySnapshotManager:
    ...
    global _snapshot_manager, _snapshot_manager_storage
    if _snapshot_manager is None or storage_adapter is not _snapshot_manager_storage:
        _snapshot_manager = TopologySnapshotManager(storage_adapter)
        _snapshot_manager_storage = storage_adapter
