    ...
    async def _execute_run(self, run_id: str, timeout_seconds: int) -> None:
        ...
        try:
            result = await dispatch_command(
                ...
                target_cluster_id=as_str(run.get("target_cluster_id", "")),
        ...
        if maybe_retry:
            ...
            if rewritten_command and rewritten_command != original_command:
                ...
                retry_result = await dispatch_command(
                    ...
                    target_cluster_id=as_str(current_snapshot.get("target_cluster_id", "")),
        ...
        while True:
            ...
            retry_result = await dispatch_command(
                ...
                target_cluster_id=as_str(run_after_dispatch.get("target_cluster_id", "")),
